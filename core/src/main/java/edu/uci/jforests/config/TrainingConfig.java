...
public class TrainingConfig extends ComponentConfig {
	...
	public final static String FEATURE_NAMES_FILENAME = "input.train.feature-names-file";
	...
	public void init(ConfigHolder config) {
		for (Entry<Object, Object> entry : config.getEntries()) {
			...
			if (key.equals(TRAIN_FILENAME)) {
				...
				validFilename = value;
			} else if (key.equals(FEATURE_NAMES_FILENAME)) {
	...
	public String toString() {
		...
		sb.append(FEATURE_NAMES_FILENAME + ": " + featureNamesFilename + "\n");
